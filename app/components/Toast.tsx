...
export default function Toast({
  ...
  return createPortal(
    ...
    >
      ...
      >
        <div className="w-72 h-72 sm:w-96 sm:h-96 flex flex-col justify-center items-center bg-[#f4ecd8] border-2 border-stone-800 shadow-[6px_6px_0_rgba(0,0,0,0.3)] p-6 sm:p-8 text-center">
          <p className="text-xs tracking-[0.3em] uppercase text-stone-500 mb-2">
            The Daily Regret
          </p>
          <div className="w-16 border-t border-stone-400 mb-4" />
          <h2 className="font-serif text-xl sm:text-4xl font-black uppercase leading-tight text-stone-900">
            {message}
          </h2>
